...
#'
#' @param svrepstat An object of class \code{'svrepstat'},
#'  which is an estimate created from a bootstrap replicate survey design object,
#'  using a function such as \code{svymean(..., return.replicates = TRUE)} or \code{withReplicates(..., return.replicates = TRUE)}.
#'
