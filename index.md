...
> Analyzing Survey Replicate Weights”. R package version 0.9.1. DOI:
...
replicate weights. The function
...
[`redistribute_weights()`](https://bschneidr.github.io/svrep/reference/redistribute_weights.md),
adjustments are conducted separately in different groups. This can be
...
different sets of weights. The function
...
helps by allowing you to quickly summarize the replicate weights.
...
in each replicate. We can use the
[`summarize_rep_weights()`](https://bschneidr.github.io/svrep/reference/summarize_rep_weights.md)
to compare summary statistics for each replicate, and we can use its
...
variance-covariance matrix, while the function
[`calibrate_to_sample()`](https://bschneidr.github.io/svrep/reference/calibrate_to_sample.md)
requires the user to supply a dataset with replicate weights to use for
