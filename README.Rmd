...
To help us estimate sampling variances, we can create bootstrap replicate weights. The function `as_bootstrap_design()` creates bootstrap replicate weights appropriate to the complex sampling design, using bootstrapping methods from the 'survey' package as well as additional methods such as the Rao-Wu-Yue-Beaumont method (a generalization of the Rao-Wu bootstrap).
